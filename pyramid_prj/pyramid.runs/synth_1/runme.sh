...
HD_PWD='C:/Users/frede/OneDrive/Documents/fred_projet/pyramid_prj/pyramid.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_pyramid_kp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_pyramid_kp.tcl
