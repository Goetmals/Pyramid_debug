...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MAX_SIZE_LIST" -parent ${Page_0}
...
proc update_PARAM_VALUE.MAX_SIZE_LIST { PARAM_VALUE.MAX_SIZE_LIST } {
	# Procedure called to update MAX_SIZE_LIST when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MAX_SIZE_LIST { PARAM_VALUE.MAX_SIZE_LIST } {
	# Procedure called to validate MAX_SIZE_LIST
	return true
}


proc update_MODELPARAM_VALUE.MAX_SIZE_LIST { MODELPARAM_VALUE.MAX_SIZE_LIST PARAM_VALUE.MAX_SIZE_LIST } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_SIZE_LIST}] ${MODELPARAM_VALUE.MAX_SIZE_LIST}
}
