...
sed -i -e "s/F0/240/g" $NOM.pgm
sed -i -e "s/F1/241/g" $NOM.pgm
sed -i -e "s/F2/242/g" $NOM.pgm
sed -i -e "s/F3/243/g" $NOM.pgm
sed -i -e "s/F4/244/g" $NOM.pgm
sed -i -e "s/F5/245/g" $NOM.pgm
sed -i -e "s/F6/246/g" $NOM.pgm
sed -i -e "s/F7/247/g" $NOM.pgm
sed -i -e "s/F8/248/g" $NOM.pgm
sed -i -e "s/F9/249/g" $NOM.pgm
sed -i -e "s/FA/250/g" $NOM.pgm
sed -i -e "s/FB/251/g" $NOM.pgm
sed -i -e "s/FC/252/g" $NOM.pgm
sed -i -e "s/FD/253/g" $NOM.pgm
sed -i -e "s/FE/254/g" $NOM.pgm
sed -i -e "s/FF/255/g" $NOM.pgm

#ajout de l'entête pour un fichier pgm
sed -i '1i 255' $NOM.pgm
sed -i '1i 512 512' $NOM.pgm
sed -i '1i P2' $NOM.pgm
