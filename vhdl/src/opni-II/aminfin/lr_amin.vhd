...
--  définition de l'architecture de LR_AMIN
-- ------------------------------------------------------------------------- --
architecture ARCH_LR_AMIN of LR_AMIN is
...
attribute syn_black_box of dp_amin: component is true;

-- synopsys translate_off
for DPA0:dp_amin use entity XilinxCoreLib.blkmemv2dp_v2_0(behavioral)
		generic map(
			c_depth_b => 1536,
			c_depth_a => 1536,
			c_has_rdyb => 0,
