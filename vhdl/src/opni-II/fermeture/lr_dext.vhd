...
--  définition de l'architecture de LR_DEXT
-- ------------------------------------------------------------------------- --
architecture ARCH_LR_DEXT of LR_DEXT is
...
attribute syn_black_box of dp_dext: component is true;

-- synopsys translate_off
for DPD0:dp_dext use entity XilinxCoreLib.blkmemv2dp_v2_0(behavioral)
		generic map(
			c_depth_b => 1536,
			c_depth_a => 1536,
			c_has_rdyb => 0,
