...
--  module AMELIORATION_II
-- ------------------------------------------------------------------------- --
entity AMELIORATION_II is 
   port ( 
	 resetb		: in	std_logic;
	 clkb		: in	std_logic;
...
--  définition de l'architecture de AMELIORATION_II
-- ------------------------------------------------------------------------- --
architecture ARCH_AMELIORATION_II of AMELIORATION_II is
...
component LR_DEXT
   port ( 
	...
	signal  Cc_new			: std_logic_vector( 1 downto 0);
	...
	begin
		...
		-- ------------------------------------------------- --
			...
			-- ----------------------------------------- --
				...
				bus_addresse <= lsb_Db & lsb_Cb & lsb_Gb & lsb_Gc 
		       			       &lsb_Gh & lsb_Ch & lsb_Dh & lsb_Dc;
