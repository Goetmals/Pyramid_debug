...
--  définition de l'architecture de LR_AMEL_II
-- ------------------------------------------------------------------------- --
architecture ARCH_LR_AMEL_II of LR_AMEL_II is
...
attribute syn_black_box of dp_amel: component is true;

-- synopsys translate_off
for DPA0:dp_amel use entity XilinxCoreLib.blkmemv2dp_v2_0(behavioral)
		generic map(
			c_depth_b => 1536,
			c_depth_a => 1536,
			c_has_rdyb => 0,
...
-- synopsys translate_on
	...
	signal	we			: std_logic;
	signal	decalb_r		: std_logic_vector( 3 downto 0);
...
RTD0:	process( resetb, clkb )
	begin
		...
		-- ------------------------------------------------- --
			...
			decalb_r <= decalb_r(2 downto 0) & decalb;
		end if;
	end process;
