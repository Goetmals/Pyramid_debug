...
#
# Script generated by Vivado on Tue Jun 09 14:07:07 CEST 2026
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : dp_grad_tarek.sh
...
#
# Usage        : dp_grad_tarek.sh
#                dp_grad_tarek.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dp_grad_tarek.sh [-reset_run]
#                dp_grad_tarek.sh [-reset_log]
#                dp_grad_tarek.sh [-help]
#
...
#                script (type 'dp_grad_tarek.sh -help' for more information).
#
...
# script info
echo -e "dp_grad_tarek.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dp_grad_tarek.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dp_grad_tarek xil_defaultlib.glbl -o dp_grad_tarek_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dp_grad_tarek_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/demelo/vivado_prjs/testbench_eads/test_grad_imv/test_grad_imv.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dp_grad_tarek_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dp_grad_tarek_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dp_grad_tarek.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dp_grad_tarek.sh [-help]\n\
Usage: dp_grad_tarek.sh [-step]\n\
Usage: dp_grad_tarek.sh [-lib_map_path]\n\
Usage: dp_grad_tarek.sh [-reset_run]\n\
Usage: dp_grad_tarek.sh [-reset_log]\n\
Usage: dp_grad_tarek.sh [-keep_index]\n\
Usage: dp_grad_tarek.sh [-noclean_files]\n\n\
