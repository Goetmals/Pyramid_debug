...
#
# Script generated by Vivado on Wed Apr 09 10:44:37 CEST 2025
...
#
# Usage        : dp_grad.sh
#                dp_grad.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dp_grad.sh [-reset_run]
#                dp_grad.sh [-reset_log]
#                dp_grad.sh [-help]
#
...
# script info
echo -e "dp_grad.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dp_grad.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dp_grad xil_defaultlib.dp_grad xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dp_grad -key {Behavioral:sim_1:Functional:dp_grad} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dp_grad.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dp_grad.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dp_grad.sh [-help]\n\
Usage: dp_grad.sh [-step]\n\
Usage: dp_grad.sh [-lib_map_path]\n\
Usage: dp_grad.sh [-reset_run]\n\
Usage: dp_grad.sh [-reset_log]\n\
Usage: dp_grad.sh [-keep_index]\n\
Usage: dp_grad.sh [-noclean_files]\n\n\
