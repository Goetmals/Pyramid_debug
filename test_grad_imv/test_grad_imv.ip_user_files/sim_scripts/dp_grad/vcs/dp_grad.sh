...
#                script (type 'dp_grad.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dp_grad xil_defaultlib.glbl -o dp_grad_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dp_grad_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dp_grad_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dp_grad_simv.daidir vcs_lib c.obj)
