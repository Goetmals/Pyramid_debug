...
HD_PWD='/home/demelo/vivado_prjs/testbench_eads/test_grad_imv/test_grad_imv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gaussian_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gaussian_filter.tcl
