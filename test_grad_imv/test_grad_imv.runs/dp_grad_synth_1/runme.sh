...
HD_PWD='/home/demelo/vivado_prjs/testbench_eads/test_grad_imv/test_grad_imv.runs/dp_grad_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dp_grad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dp_grad.tcl
