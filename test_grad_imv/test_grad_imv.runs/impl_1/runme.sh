...
HD_PWD='/home/demelo/vivado_prjs/testbench_eads/test_grad_imv/test_grad_imv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gaussian_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gaussian_filter.tcl -notrace
