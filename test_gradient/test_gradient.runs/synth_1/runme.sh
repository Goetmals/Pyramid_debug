...
HD_PWD='/home/demelo/vivado_prjs/testbench_eads/test_gradient/test_gradient.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LR_GRAD_TAREK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LR_GRAD_TAREK.tcl
