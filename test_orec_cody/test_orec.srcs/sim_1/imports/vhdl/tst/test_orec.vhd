...
generic (
	  ...
	  nomDest	: string  := "C:\Users\frede\OneDrive\Documents\testbench_eads\vhdl\tst\ImageTests\cube_grad.imv";
...
--	csin5 <= conv_std_logic_vector( 43,7 );
	...
	camp  <= conv_std_logic_vector( 63,8 );
...
--	seuil_haut <= conv_std_logic_vector( 4,8 );
	...
	mode  <= conv_std_logic_vector( 2,3 );
